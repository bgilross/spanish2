...
const spanishData = {
	lessons: {
		1: {
			...
			info: [
				"This Language course is focused on reuslts and genuine fluency. We aim to have you thinking in Spanish ASAP, and from there sounding more like a native speaker every day.",
				"Vocab will ALWAYS make contextual sense. Grammar rules will ALWAYS integrate with what you already know, helping you to naturally form sentences. Every new word will fir tinto a fabric that will quickly grow and develop into your SPANISH VOICE so that you can speak Idiomatically faster than ever!",
				...
				"One of the most important objectives on the road to fluency is SPONTANEOUS PRODUCTION, coming up with your own sentences on the fly, in a smoot way. Practice changing the sentences and making them your own as well!",
			],
			wordBank: [],
			sentences: [],
		},
		2: {
			...
			info: [
				"What is deep fundamental grammar? Well you can't build a house from scratch, you need a foundation first. During the first 10 lessons we are going to build (or rebuild) your Spanish SYNTAX and GRAMMAR from their roots. These will be some of the hardest work in the course ",
				"We will be spending a lot of time on a few words, 20 words make up 30% of ALL words spoken in Spanish, and about 100 words make up over 50%!",
				"We will be focusing on the first 20. Not just what they mean, but how to use them in a secntence like a Native Speaker would!",
